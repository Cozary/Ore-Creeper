...
public class OreCreeperNeoForge {
    ...
    public void setupCommon(final FMLCommonSetupEvent event) {
        ...
        event.enqueueWork(() -> {
                    ...
                    SpawnPlacements.register(ModEntityTypes.ANCIENT_DEBRIS_CREEPER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, AncientDebrisCreeperEntity::canOreCreeperSpawn);
                }
        );
    }
}