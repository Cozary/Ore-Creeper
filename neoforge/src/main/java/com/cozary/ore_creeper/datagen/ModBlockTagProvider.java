...
public class ModBlockTagProvider extends net.neoforged.neoforge.common.data.BlockTagsProvider {
    ...
    public static final TagKey<Block> SPAWNABLE_BLOCKS = BlockTags.create(ResourceLocation.fromNamespaceAndPath(OreCreeper.MOD_ID, "spawnable_blocks"));
    public static final TagKey<Block> SPAWNABLE_BLOCKS_NETHER = BlockTags.create(ResourceLocation.fromNamespaceAndPath(OreCreeper.MOD_ID, "spawnable_blocks_nether"));
