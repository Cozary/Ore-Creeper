...
public class ClientEventBusSubscriber {
    ...
    public static ModelLayerLocation ANCIENT_DEBRIS_CREEPER = new ModelLayerLocation(new ResourceLocation(OreCreeper.MOD_ID, "ancient_debris_creeper"), "ancient_debris_creeper");
