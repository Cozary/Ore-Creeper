...
public class ModTags {
    ...
    public static final TagKey<Biome> SPAWNABLE_BIOMES = TagKey.create(
            Registries.BIOME,
            Identifier.fromNamespaceAndPath(MOD_ID, "spawnable_biomes")
    );

    public static final TagKey<Biome> BLACKLIST_BIOMES = TagKey.create(
            Registries.BIOME,
            Identifier.fromNamespaceAndPath(MOD_ID, "blacklist_biomes")
    );

    public static final TagKey<Block> SPAWNABLE_BLOCKS = TagKey.create(
            Registries.BLOCK,
            Identifier.fromNamespaceAndPath(MOD_ID, "spawnable_blocks")
    );

    public static final TagKey<Biome> SPAWNABLE_BIOMES_NETHER = TagKey.create(
            Registries.BIOME,
            Identifier.fromNamespaceAndPath(MOD_ID, "spawnable_biomes_nether")
    );

    public static final TagKey<Biome> BLACKLIST_BIOMES_NETHER = TagKey.create(
            Registries.BIOME,
            Identifier.fromNamespaceAndPath(MOD_ID, "blacklist_biomes_nether")
    );
