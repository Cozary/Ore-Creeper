...
public class LapisLazuliCreeperEntity extends AbstractOreCreeperEntity {
    ...
    protected ExplosionTypes.OreType getOreType() {
        return ExplosionTypes.OreType.LAPIS;
    }

    @Override
    protected ParticleOptions getExplosionParticle() {
        return ParticleList.LAPIS_EXPLOSION.get();
    }
    ...
    public static boolean canOreCreeperSpawn(EntityType<? extends AbstractOreCreeperEntity> creeper, ServerLevelAccessor world, EntitySpawnReason reason, BlockPos pos, RandomSource random) {
        return checkSpawnRules(creeper, world, reason, pos, random, CommonConfigManager.getConfig().lapisLazuliCreeperMaxSpawnYLevel(), false);
    }
}
