...
public class DiamondCreeperEntity extends AbstractOreCreeperEntity {
    ...
    protected ExplosionTypes.OreType getOreType() {
        return ExplosionTypes.OreType.DIAMOND;
    }

    @Override
    protected ParticleOptions getExplosionParticle() {
        return ParticleList.DIAMOND_EXPLOSION.get();
    }
    ...
    public static boolean canOreCreeperSpawn(EntityType<? extends AbstractOreCreeperEntity> creeper, ServerLevelAccessor world, EntitySpawnReason reason, BlockPos pos, RandomSource random) {
        return checkSpawnRules(creeper, world, reason, pos, random, CommonConfigManager.getConfig().diamondCreeperMaxSpawnYLevel(), false);
    }
}
