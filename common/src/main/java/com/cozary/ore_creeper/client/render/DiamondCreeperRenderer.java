...
public class DiamondCreeperRenderer extends MobRenderer<DiamondCreeperEntity, CreeperRenderState, OreCreeperModel> {

    protected static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(OreCreeper.MOD_ID, "textures/entity/diamond_creeper.png");
    ...
    public @NotNull Identifier getEntityIconLoc(@NotNull DiamondCreeperEntity p_114041_) {
        return entityIconLoc;
    }

    public void extractRenderState(DiamondCreeperEntity p_364394_, CreeperRenderState p_361451_, float p_364659_) {
