...
public class CopperCreeperRenderer extends MobRenderer<CopperCreeperEntity, CreeperRenderState, OreCreeperModel> {

    protected static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(OreCreeper.MOD_ID, "textures/entity/copper_creeper.png");
    ...
    public @NotNull Identifier getEntityIconLoc(@NotNull CopperCreeperEntity p_114041_) {
        return entityIconLoc;
    }

    public void extractRenderState(CopperCreeperEntity p_364394_, CreeperRenderState p_361451_, float p_364659_) {
