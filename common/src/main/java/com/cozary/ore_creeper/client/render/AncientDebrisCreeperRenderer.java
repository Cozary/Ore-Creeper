...
public class AncientDebrisCreeperRenderer extends MobRenderer<AncientDebrisCreeperEntity, CreeperRenderState, OreCreeperModel> {
    ...
    protected static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(OreCreeper.MOD_ID, "textures/entity/ancient_debris_creeper.png");
    ...
    public @NotNull Identifier getEntityIconLoc(@NotNull AncientDebrisCreeperEntity p_114041_) {
