...
public class EmeraldCreeperRenderer extends MobRenderer<EmeraldCreeperEntity, CreeperRenderState, OreCreeperModel> {
    ...
    protected static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(OreCreeper.MOD_ID, "textures/entity/emerald_creeper.png");
    ...
    public @NotNull Identifier getEntityIconLoc(@NotNull EmeraldCreeperEntity p_114041_) {
