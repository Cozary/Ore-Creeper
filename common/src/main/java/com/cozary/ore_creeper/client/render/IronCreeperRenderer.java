...
public class IronCreeperRenderer extends MobRenderer<IronCreeperEntity, OreCreeperModel<IronCreeperEntity>> {
    ...
    protected void scale(IronCreeperEntity p_114046_, PoseStack p_114047_, float p_114048_) {
    ...
    protected float getWhiteOverlayProgress(IronCreeperEntity p_114043_, float p_114044_) {
        float f = p_114043_.getSwelling(p_114044_);
        return (int) (f * 10.0F) % 2 == 0 ? 0.0F : Mth.clamp(f, 0.5F, 1.0F);
    }

    public @NotNull ResourceLocation getTextureLocation(@NotNull IronCreeperEntity p_114041_) {
        return TEXTURE;
    }
