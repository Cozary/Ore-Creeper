...
public class GoldCreeperRenderer extends MobRenderer<GoldCreeperEntity, CreeperRenderState, OreCreeperModel> {
    ...
    protected static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(OreCreeper.MOD_ID, "textures/entity/gold_creeper.png");
    ...
    public @NotNull Identifier getEntityIconLoc(@NotNull GoldCreeperEntity p_114041_) {
