...
public class CoalCreeperRenderer extends MobRenderer<CoalCreeperEntity, CreeperRenderState, OreCreeperModel> {

    protected static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(OreCreeper.MOD_ID, "textures/entity/coal_creeper.png");
    ...
    public CoalCreeperRenderer(EntityRendererProvider.Context context) {
        super(context, new OreCreeperModel(context.bakeLayer(ClientEventBusSubscriber.COAL_CREEPER)), 0.5F);
    }
    ...
    public @NotNull Identifier getEntityIconLoc(@NotNull CoalCreeperEntity p_114041_) {
        return entityIconLoc;
    }

    public void extractRenderState(CoalCreeperEntity p_364394_, CreeperRenderState p_361451_, float p_364659_) {
