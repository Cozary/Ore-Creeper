...
public class RedstoneCreeperRenderer extends MobRenderer<RedstoneCreeperEntity, CreeperRenderState, OreCreeperModel> {

    protected static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(OreCreeper.MOD_ID, "textures/entity/redstone_creeper.png");
    ...
    public @NotNull Identifier getEntityIconLoc(@NotNull RedstoneCreeperEntity p_114041_) {
        return entityIconLoc;
    }

    public void extractRenderState(RedstoneCreeperEntity p_364394_, CreeperRenderState p_361451_, float p_364659_) {
