...
public class NetherQuartzCreeperRenderer extends MobRenderer<NetherQuartzCreeperEntity, CreeperRenderState, OreCreeperModel> {
    ...
    protected static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(OreCreeper.MOD_ID, "textures/entity/nether_quartz_creeper.png");
    ...
    public @NotNull Identifier getEntityIconLoc(@NotNull NetherQuartzCreeperEntity p_114041_) {
