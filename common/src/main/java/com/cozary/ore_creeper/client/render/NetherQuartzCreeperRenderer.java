...
public class NetherQuartzCreeperRenderer extends MobRenderer<NetherQuartzCreeperEntity, CreeperRenderState, OreCreeperModel> {
    ...
    public void extractRenderState(NetherQuartzCreeperEntity p_364394_, CreeperRenderState p_361451_, float p_364659_) {
